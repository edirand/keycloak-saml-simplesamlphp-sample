...
| :---------------------: | :------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------ |
| KC_URL                  | http://localhost:8050                  | The base url of Keycloak                                                                                                              |
| IDP_URL                 | http://localhost:8080                  | The base url of SimpleSAMLphp                                                                                                         |
| KC_SAML_ENTITY_ID       | http://localhost:8050/realms/saml-poc  | The entity ID of our Keycloak broker in SimpleSAMLphp (used to allow Keycloak to redirect login to SimpleSAMLphp)                     |
| REALM_NAME              | saml-poc                               | The Keycloak realm we will use to setup SAML Identity Provider                                                                        |
| ALIAS                   | simplesaml                             | The alias of the SAML Identity Provider defined in Keycloak (used in the redirect url between keycloak and SimpleSAMLphp after login) | 
| TEST_APP_CLIENT_ID      | test-app                               | The Client ID of the test app                                                                                                         |
| TEST_APP_CLIENT_SECRET  | generated by keycloak in this tutorial | The Client Secret of the test app                                                                                                     |
| TEST_APP_URL            | localhost:3000                         | The base url of the test app                                                                                                          |
| NEXT_AUTH_SECRET        | generated by Vercel in this tutorial   | The secret used by Auth.js for the test app                                                                                           |
