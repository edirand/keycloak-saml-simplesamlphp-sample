...
/**
*   This file contains default admin and users that will be created automatically when executing SimpleSAMLphp.
*   Here we used attributes that mimic those of Azure AD to have enough data for demonstration.
*
*   See: https://simplesamlphp.org/docs/stable/simplesamlphp-sp.html
*   Or for example: https://docs.acquia.com/resource/simplesaml/sources/
*/
